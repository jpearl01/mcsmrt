...
out_file.puts("read_name\tforward_primer_match\treverse_primer_match\tforward_primer_start\tforward_primer_end\treverse_primer_start\treverse_primer_end\tread_orientation\tgaps\tprimer_note\tnum_of_primer_hits")
...
class Primer_info
  attr_accessor :num_of_hits, :f_primer_matches, :r_primer_matches, :f_primer_start, :f_primer_end, :r_primer_start, :r_primer_end, :read_orientation, :gaps, :primer_note
...
def print_info (record_hash, primer_hash, out_file, seqs_hash)
	record_hash.each do |key, value|
        ...
        primer_hash[key].num_of_hits = 2
          ...
          primer_hash[key].gaps = [value[0][4].to_i,value[1][4].to_i]
        ...
        primer_hash[key].num_of_hits = value.size
        fow_ind = nil
        rev_ind = nil
        ...
        if fow_ind != nil and rev_ind != nil
          ...
          primer_hash[key].gaps = [value[fow_ind][4].to_i,value[rev_ind][4].to_i]
          if value[fow_ind][1] == "+"
            primer_hash[key].read_orientation = "+"
          else
            primer_hash[key].read_orientation = "-"
          ...
          primer_hash[key].r_primer_end     = "NA"
          primer_hash[key].read_orientation = "NA"
          primer_hash[key].gaps = ["NA","NA"]
          primer_hash[key].primer_note = "multiple_primers_hits"
        end

  		# When size of value == 1, its a singleton
  		elsif value.size == 1
        primer_hash[key].num_of_hits = 1
          ...
          primer_hash[key].gaps = [value[0][4].to_i]
  			end
  	...
  	out_file.puts("#{key}\t#{primer_hash[key].f_primer_matches}\t#{primer_hash[key].r_primer_matches}\t#{primer_hash[key].f_primer_start}\t#{primer_hash[key].f_primer_end}\t#{primer_hash[key].r_primer_start}\t#{primer_hash[key].r_primer_end}\t#{primer_hash[key].read_orientation}\t#{primer_hash[key].gaps.inspect}\t#{primer_hash[key].primer_note}\t#{primer_hash[key].num_of_hits}")
